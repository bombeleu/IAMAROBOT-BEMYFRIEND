...
public class DebugConsole : MonoBehaviour
{
	...
	public GameObject RobotEffectLocation;
	public GameObject BeepEffect;
    ...
    {
        _instance = this;
		currentRobot = GameObject.FindGameObjectWithTag("Robot");
		RobotEffectLocation = GameObject.FindGameObjectWithTag("roboteffectloc");
       ...
       // this.RegisterCommandCallback( "close", CMDClose );
		...
		//Control Commands
		this.RegisterCommandCallback( "MoveForward" , CMDMoveForward);
		this.RegisterCommandCallback( "MoveBackward" , CMDMoveBackward);
		this.RegisterCommandCallback( "TurnLeft" , CMDTurnLeft);
		this.RegisterCommandCallback( "TurnRight" , CMDTurnRight);
		
		//Helpful Commands
		this.RegisterCommandCallback( "Help" , CMDHelp);
		
		//Shorthand Cmds
		this.RegisterCommandCallback( "fw" , CMDMoveForward);
		this.RegisterCommandCallback( "bk" , CMDMoveBackward);
		this.RegisterCommandCallback( "tl" , CMDTurnLeft);
		this.RegisterCommandCallback( "tr" , CMDTurnRight);
		
		
		//BASIC syntax commands - (Easter eggs!)
		this.RegisterCommandCallback( "CLS", CMDClear );
		this.RegisterCommandCallback( "PRINT", CMDPrint);
    ...
    void OnGUI()
    {
        if ( _isOpen )
        {
			...
			_windowRect.width = (s_width / 3.0F);
			_windowRect.height = (s_height*0.95f);
        }
    }
...
/*    public static void RegisterWatchVar( string name, WatchVar watchVar )
	...
	public void CMDGenSmallTestLevel(params string[] args)
	{
		GridGenerator.instance.Generate(Vector3.zero, 5, 5);
	}
	public void CMDGenLargeTestLevel(params string[] args)
	{
		GridGenerator.instance.Generate(Vector3.zero, 15, 15);
	}
	
	public void CMDMoveForward(params string[] args)
	{
		//Instantiate(BeepEffect);
		currentRobot.GetComponent("GridMove").SendMessage("MoveForward" , 1);
	}
	public void CMDMoveBackward(params string[] args)
	{
		//Instantiate(BeepEffect,RobotEffectLocation.transform,RobotEffectLocation.transform.rotation);
		currentRobot.GetComponent("GridMove").SendMessage("MoveBackward" ,1);
	}
	public void CMDTurnLeft(params string[] args)
	{
		//Instantiate(BeepEffect);
		currentRobot.GetComponent("GridMove").SendMessage("TurnLeft");
	}
	public void CMDTurnRight(params string[] args)
	{
		//Instantiate(BeepEffect,RobotEffectLocation.transform,RobotEffectLocation.transform.rotation);
		currentRobot.GetComponent("GridMove").SendMessage("TurnRight");
	}
